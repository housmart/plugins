...
class WebSettings {
  ...
  @override
  String toString() {
    return 'WebSettings(javascriptMode: $javascriptMode, hasNavigationDelegate: $hasNavigationDelegate, debuggingEnabled: $debuggingEnabled, allowsBack: $allowsBack, userAgent: $userAgent,)';
  }
}
